...
template<typename T>
void* thread_send_requests_for_emplace_find(void* threadArgs) {
WorkerArgs* args = static_cast<WorkerArgs*>(threadArgs);
...
template<typename T>
void* thread_send_requests_for_insert_find(void* threadArgs) {
WorkerArgs* args = static_cast<WorkerArgs*>(threadArgs);
